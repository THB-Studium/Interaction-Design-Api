...
public class ItBase {
	...
	protected ReisenderWriteTO buildReisenderWriteTO() {
		...
		reisender.setEmail("jigale1839@shbiso.com");
	...
	protected Buchung buildBuchung(Reisender reisender, ReiseAngebot ra) {
		...
		newBuchung.setHandGepaeckReisender(true);
		newBuchung.setHandGepaeckMitReisender(false);
	...
	protected BuchungUpdateTO buildBuchungUpdateTO(UUID buchungsklasseId, UUID raId, UUID mitreisenderId,
			UUID reisenderId) {
